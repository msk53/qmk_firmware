...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
                        KC_LGUI, DEL_ALT,   LW_MHEN,  KC_ENT,    MS_BTN1,                MS_BTN2,  KC_SPC, RS_HENK, KC_BSPC,  KC_ESC,
  ...
  //|-------------------------------------------------------|                                   |-------------------------------------------------------|
                        KC_LGUI, DEL_ALT, KC_TRNS,  _______,     MS_BTN1,                MS_BTN2, _______, RS_HENK, KC_BSPC,  KC_ESC,
                                                                 KC_PGUP,    MS_BTN3,    KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX
                                                            //`--------------'  `--------------'
    ),
  [_Layer5] = LAYOUT(
